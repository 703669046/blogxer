        ...
        <section class="post-info-box">
            ...
            <div class="user-box">
                ...
                <div class="user-info-box">
                    ...
                    <span class="span-block">
                        <i class="el-icon-view"></i>&nbsp;&nbsp;{{obj.browse}}
                    </span>
                    <span class="span-block"><i class="el-icon-star-on"></i>收藏&nbsp;{{obj.collects}}</span>
                    <span class="span-block">来源：<el-tag>{{obj.source}}</el-tag></span>
                    <span class="span-block">分类专栏：<el-tag>{{obj.category_title}}</el-tag></span>
                </div>
            </div>
            <div class="reander-box" v-html="obj.context"></div>
            <div class="bottom-box">
                <el-button type="text" @click="handlePraises" icon="el-icon-thumb">点赞</el-button>
                <el-button type="text" @click="handleCollects" icon="el-icon-star-on">收藏</el-button>
            </div>
        </section>
    </div>
</template>
